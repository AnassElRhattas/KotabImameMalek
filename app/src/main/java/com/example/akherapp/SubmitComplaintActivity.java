...
public class SubmitComplaintActivity extends BaseUserActivity {
    ...
    private static final String PREF_FIRST_TIME_COMPLAINT = "first_time_complaint";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupSubmitButton();
        loadUserComplaints();
        setupTutorial(); // Add this line to call the tutorial setup
    }
    ...
    private void setupTutorial() {
        ...
        if (isFirstTime) {
            new TapTargetSequence(this)
                    .targets(
                            TapTarget.forView(findViewById(R.id.subjectInput), "عنوان الشكوى",
                                            "اكتب هنا عنواناً مختصراً لشكواك")
                            ...
                            TapTarget.forView(findViewById(R.id.descriptionInput), "تفاصيل الشكوى",
                                            "اشرح هنا تفاصيل شكواك بشكل واضح")
                                    .outerCircleColor(R.color.purple_800)
                                    .outerCircleAlpha(0.96f)
                                    .targetCircleColor(R.color.white)
                                    .titleTextSize(20)
                            ...
                            TapTarget.forView(findViewById(R.id.submitButton), "إرسال الشكوى",
                                            "اضغط هنا لإرسال شكواك")
                                    .outerCircleColor(R.color.purple_800)
                                    .outerCircleAlpha(0.96f)
                                    .targetCircleColor(R.color.white)
                                    .titleTextSize(20)
                    ...
                    .listener(new TapTargetSequence.Listener() {
                        ...
                        public void onSequenceFinish() {
                            ...
                            editor.putBoolean(PREF_FIRST_TIME_COMPLAINT, false);
                            editor.apply();
                        }
